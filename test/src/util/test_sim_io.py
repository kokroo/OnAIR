...
def test_sim_io_render_reasoning_writes_txt_and_csv_files_even_when_list_is_empty(
    ...
    mocker.patch(
        "onair.src.util.sim_io.os.environ.get", return_value=fake_system_filename
    )
    ...
    assert onair.src.util.sim_io.os.path.join.call_args_list[0].args == (
    ...
    assert onair.src.util.sim_io.os.path.join.call_args_list[1].args == (
        fake_system_filename,
        "diagnosis.csv",
    )
...
def test_sim_io_render_viz_does_only_stattest_render_viz_does_status_sensor_and_diagnosis_reports_when_diagnosis_is_givenus_and_sensor_reports_when_diagnosis_is_not_given(
    ...
    assert onair.src.util.sim_io.json.dump.call_args_list[0].args == (
        expected_status_report,
        fake_iterator,
    )
    assert onair.src.util.sim_io.os.environ.get.call_args_list[1].args == (SAVE_PATH,)
    ...
    assert onair.src.util.sim_io.json.dump.call_args_list[1].args == (
        expected_sensor_status_report,
        fake_iterator,
    )
...
def test_sim_io_render_viz_does_only_status_and_sensor_reports_when_diagnosis_is_given_as_None(
    ...
    # Act
    onair.src.util.sim_io.render_viz(
        arg_status_data, arg_sensor_data, arg_sim_name, arg_diagnosis
    )
...
def test_sim_io_render_viz_does_status_sensor_and_diagnosis_reports_when_diagnosis_is_given(
    ...
    assert onair.src.util.sim_io.os.path.join.call_args_list[2].args == (
        fake_system_filename,
        "results.json",
    )
    assert open.call_args_list[2].args == (fake_full_path, "w")
    assert onair.src.util.sim_io.json.dump.call_args_list[2].args == (
        fake_results,
        fake_iterator,
    )
